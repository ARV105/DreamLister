...
//  DreamLister
//
//  Created by Auriel on 4/5/17.
//  Copyright © 2017 Auriel. All rights reserved.
//

import UIKit
/** extension will allow UIColor to change the settings by a hex value */

extension UIColor {
    convenience init(red: Int, green: Int, blue: Int) {
        //Verify we have valid lines
    ...
    /** Initialize and sets color by the hex value */
